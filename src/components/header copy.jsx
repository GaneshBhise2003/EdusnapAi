...
//                     className="ml-4 px-4 py-2 rounded-full bg-red-500 text-white font-semibold shadow hover:scale-105 transition-transform"
//                   >
//                     Logout
//                   </button>
//                   <button
//                     onClick={() => navigate("/profile")}
//                     className="ml-4 px-4 py-2 rounded-full bg-gradient-to-r from-purple-500 to-indigo-500 text-white font-semibold shadow hover:scale-105 transition-transform"
//                   >
//                     Profile
//                   </button>
//                 </>
